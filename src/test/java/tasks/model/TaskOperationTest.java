...
class TaskOperationTest {
    ...
    public void Test1_taskIsEmpty() {
        ...
        // Act
        ArrayList<Task> result = (ArrayList<Task>) top.incoming(new Date(121, 04, 17, 12,30), new Date(121, 04, 26, 12,30));
    ...
    public void F02_incoming_tasksIsNotEmptyAndHasDatesInInterval_returnExpectedTasks() {
        ...
        tasks.add(new Task("TASK1", new Date(121, 04, 15, 12,30)));
        // valid
        tasks.add(new Task("TASK2", new Date(121, 04, 20, 12,30)));
        tasks.add(new Task("TASK3", new Date(121, 04, 25, 12,30)));
        // end valid
        tasks.add(new Task("TASK4", new Date(121, 04, 30, 12,30)));
    ...
    public void F02_incoming_tasksIsNotEmptyAndDoesntHaveTasksInInterval_returnOne() {
        ...
        // Act
        ArrayList<Task> result = (ArrayList<Task>) top.incoming(new Date(121, 04, 21, 12,30), new Date(50, 04, 22, 12,30));
    ...
    public void F02_incoming_tasksHasTwoElementsAndHasDatesInInterval_returnExpectedTasks() {
        ...
        tasks.add(new Task("TASK1", new Date(121, 04, 20, 12,30)));
        // valid
        tasks.add(new Task("TASK2", new Date(121, 04, 21, 12,30)));
